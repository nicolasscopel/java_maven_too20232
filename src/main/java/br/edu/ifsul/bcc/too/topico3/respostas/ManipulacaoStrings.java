...
public class ManipulacaoStrings {
    ...
    public ManipulacaoStrings(String t, String t2, String t3, String t4) {
        ...
        teste2Split("{codigo= 1},{codigo= 22},{codigo= 3009360}");
    }
    ...
    private void teste2Split(String param) {
        ...
        if (vet.length == 0) {
            ...
            for (String p : vet) { // PASSA UM ELEMENTO DE VET PARA P EM CADA REPETIÇÃO
                System.out.println("p:" + p);
                System.out.println("Indice do espaço: " + p.indexOf(" "));
                System.out.println("Indice do }: " + p.indexOf("}"));
                //System.out.println("Valor: "+p.substring(p.indexOf(" ")+1, p.indexOf("}")));

                String subP = p.substring(p.indexOf(" ") + 1, p.indexOf("}"));
